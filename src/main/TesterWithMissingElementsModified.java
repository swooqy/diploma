...
public class TesterWithMissingElementsModified {
    public static double[] test(double[][]covarianceMatrix,double hypotesis1,double hypotesis2,double alpha,double beta,int dimensionSize,int timesToTest,int[] elementsToMiss){
        ...
        int timeserror1=0;
        int timeserror2=0;
        StatisticsTester gen1=new StatisticsTesterWithMissingElementsModified(means,covarianceMatrix,0,alpha,beta,elementsToMiss);
        StatisticsTester gen2=new StatisticsTesterWithMissingElementsModified(means,covarianceMatrix,1,alpha,beta,elementsToMiss);
        int[] temp1,temp2;
